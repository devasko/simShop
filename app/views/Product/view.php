            ...
            <div class="col-md-9 single-main-left">
                <div class="sngl-top">
                    <div class="col-md-5 single-top-left">
                        ...
                        <?php else: ?>
                            <img class="image_fallback img-responsive" src="images/<?= $product->img; ?>" alt="">
                        <?php endif; ?>
                    </div>
                        ...
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <ul class="tag-men">
                                ...
                                <li><span>Category</span>
                                    <span class="cat1">: <a href="category/<?= $cats[$cat['parent_id']]['alias']; ?>"><?= $cats[$cat['parent_id']]['title']; ?></a></span></li>
                                <li><span>Brand</span>
                                    <span class="brand1">: <a href="category/<?= $cats[$product->category_id]['alias']; ?>"><?= $cat['title']; ?></a></span></li>
                            </ul>
