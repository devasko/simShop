...
<head>
    ...
    <title>Заказ в магазине iShop</title>
</head>
<body>
    ...
    <table style="border: 1px solid #ddd; border-collapse: collapse; width: 100%">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="2" style="padding: 8px; border: 1px solid #ddd;">Комментарий к заказу:</td>
                <td colspan="3" style="padding: 8px; border: 1px solid #ddd;"><?= $_POST['comment']; ?></td>
            </tr>
        </tbody>
    </table>
